 ...
 */
static volatile DATA_TYPE  havege_bigarray [NDSIZECOLLECT + 16384];
static volatile DATA_TYPE  havege_andpt;
static volatile DATA_TYPE  havege_hardtick;
static volatile DATA_TYPE  loop_idx = LOOP_CT+1;
...
static volatile DATA_TYPE *havege_tune(H_PTR h);
/**
